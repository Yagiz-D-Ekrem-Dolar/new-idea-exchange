...
OUTPUT = os.path.join(os.path.dirname(os.path.abspath(__file__)), "public", "Heidelberg-New.pdf")

NAVY = HexColor("#004E2B")
BLUE = HexColor("#00873E")
BLUE_SOFT = HexColor("#e6f3ec")
GOLD = HexColor("#00DD39")
INK = HexColor("#0f172a")
...
doc = SimpleDocTemplate(
    ...
    title="Heidelberg New Pitch Deck",
    author="Aras Kilinc",
    subject="Heidelberg New - Kurumsal Inovasyon Ekosistemi Pitch Deck"
)
...
# ---- Cover ----
cover_inner = [
    [Paragraph("HEIDELBERG MATERIALS &middot; NEW IDEA EXCHANGE", COVER_EYEBROW)],
    [Spacer(1, 10 * mm)],
    [Paragraph("Heidelberg New<br/>Pitch Deck", COVER_TITLE)],
    [Spacer(1, 4 * mm)],
...
slide("Startup Tanitimi", [
    (None, "Heidelberg New, Heidelberg Materials, girisimciler, gencler ve fark yaratmak isteyen "
           ...
           "motivasyonla cok sayida insani bir araya getirerek, onlari Heidelberg Materials ve "
           "istiraklerine hizmet eden devasa bir inovasyon makinesinin uretken birer "
           "parcasina donusturur."),
    (None, "Heidelberg New, Heidelberg Materials ve istiraklerinin kisa ve uzun vadeli buyume hedefleri "
...
slide("Vizyon ve Misyon", [
    (None, "Heidelberg New, girisimci ve yenilikci beyinlerden maksimum verim alarak canli bir "
           "laboratuvar olusturmayi misyon edinirken; bu gucle Heidelberg Materials ve istiraklerini "
    ...
    ("Vizyonumuz", "New'in vizyonu, yenilikci fikirleri dusuk maliyetli bir ekosistemde "
                    "birlestirerek, Heidelberg Materials ve istiraklerini global rekabette oncu, "
    ...
    ("Misyonumuz", "New'in misyonu; girisimci, genc ve yenilikci calisanlarin yeni "
                    ...
                    "Heidelberg Materials ve istirakleri icin canli bir laboratuvar ekosistemi "
                    "olusturmaktir."),
])
...
slide("Hizmetimiz", [
    ...
    ("Ekosistem Destegi", "Heidelberg New ekosistemi; Heidelberg Materials'a dusuk maliyetli, aktif bir "
...
slide("Hedef Kitle", [
    (None, "New; Heidelberg Materials'un kurumsal yapisini sistematik bir laboratuvar disipliniyle "
    ...
    ("Heidelberg Materials ve Istirakleri", "New'in hedef kitlesi Heidelberg Materials olup, temel amaci "
