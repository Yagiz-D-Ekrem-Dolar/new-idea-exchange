...
# ─────────────────────────────────────────────────────────────────────────────
BRAND = "Sabanci Holding"
BRAND_FILE = "Sabanci-Holding"
NAVY = HexColor("#0a1628")
GREEN_MID = HexColor("#12805c")

EXEC_SUMMARY = ("Enerji, finans, sanayi, perakende, teknoloji ve surdurulebilirlik ekiplerinden "
                 "gelen fikirleri toplayan, sirketler arasi yenilik akisini olculebilir hale "
                 "getiren grup ici inovasyon platformu.")
USER_SCALE = "32.000 kullanici / 6 ulke portali"
ADMIN_LOAD_OLD = "22-34 saat/hafta normal hafta kapasitesi"
ADMIN_MODEL = "8-10 sorumlu, ulke ve is birimi temsilcilerine dagitilmis sorumluluk"
LANG_SCOPE = "Turkce, Ingilizce, Almanca"
...
SCOPE_INTRO = (f"Bu calisma, {BRAND} icin kurgulanan ID Exchange platformunun ilk uretim "
               ...
               "hesaplanmistir.")
SCOPE_FLOWS = [
    "Sabanci Holding, Akbank, Enerjisa, Kordsa, Brisa, Cimsa, Teknosa ve teknoloji odakli istirakler icin ortak inovasyon alani.",
    "Calisan fikri, proje onerisi, fikir borsasi, departman filtreleri, AI analiz ve yonetici paneli akislari.",
    "Holding geneli gorunurluk ile istirak ici gizlilik arasinda dengeli yetki modeli.",
    "Ulke ve sirket bazli raporlama; ozellikle Turkiye merkezli ama global operasyonlari destekleyen yapi.",
]

ADMIN_TASKS = [
    ("Holding geneli adil kullanim", "5-7 saat", "Fikir borsasinda koordineli oy, suni ilgi ve grup ici manipulasyonlarin izlenmesi"),
    ("Istirak bazli yonlendirme", "4-6 saat", "Akbank, Enerjisa, Kordsa, Brisa, Cimsa, Teknosa gibi sirketlere gelen fikirlerin ayristirilmasi"),
    ("Sikayet ve icerik kontrolu", "5-7 saat", "Uygunsuz yorum, kisisel veri riski ve kurum kulturune aykiri iceriklerin incelenmesi"),
    ("Dis basvuru ve is birligi akisi", "3-5 saat", "Startup ve ogrenci basvurularinin dogru birimlere aktarilmasi"),
    ("Haftalik yonetim ozeti", "5-9 saat", "En guclu fikirler, bekleyen kararlar ve departman bazli aktivite raporu"),
]

COUNTRY_TABLE = [
    ("Turkiye", "22.000", "Holding ve ana istirakler", "Turkce"),
    ("Almanya", "2.500", "Sanayi ve teknoloji operasyonlari", "Almanca/Ingilizce"),
    ("ABD", "2.500", "Teknoloji ve buyume ekipleri", "Ingilizce"),
    ("Hollanda", "2.000", "Avrupa is gelistirme", "Ingilizce"),
    ("Birlesik Krallik", "1.500", "Finans ve yatirim temaslari", "Ingilizce"),
    ("Ispanya", "1.500", "Enerji ve surdurulebilirlik ekipleri", "Ispanyolca/Ingilizce"),
]
ADMIN_BREAKDOWN_NOTE = ("8-10 sorumlu ifadesi tam zamanli admin anlamina gelmez. Bu modelde "
                         ...
                         "22-34 saat/hafta araligi yeterli gorulur; yalnizca buyuk kampanya, "
                         "odul donemi veya dis basvuru cagrisi doneminde gecici ek destek "
                         "gerekebilir.")
CONTROL_POINTS = [
    "Farkli sektorlerdeki istirakler icin gizlilik seviyeleri ayni olmamalidir; finans, enerji ve sanayi akislari ayri yetki katmanina ihtiyac duyar.",
    "Startup basvurulari ile calisan fikirleri ayni degerlendirme havuzunda tutulsa bile, gorunurluk ve onay adimlari ayrilmalidir.",
    "Fikir borsasi tesvik mekanizmasi finansal getiri vaadi gibi degil, grup ici onceliklendirme ve motivasyon sistemi olarak anlatilmalidir.",
