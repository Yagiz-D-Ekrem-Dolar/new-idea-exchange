...
# ─────────────────────────────────────────────────────────────────────────────
BRAND = "BBVA Group"
BRAND_FILE = "BBVA-Group"
NAVY = HexColor("#072146")
GREEN_MID = HexColor("#14549c")

EXEC_SUMMARY = ("Bankacilik, yatirim, sigorta ve surdurulebilir finans ekiplerinde fikir uretimi, "
                 "fikir borsasi ve yonetsel denetim sureclerini tek bir cati altinda toplayan "
                 "kurumsal inovasyon platformu.")
USER_SCALE = "50.000 kullanici / 8 ulke portali"
ADMIN_LOAD_OLD = "28-42 saat/hafta normal hafta kapasitesi"
ADMIN_MODEL = "10-14 sorumlu, ulke ve is birimi temsilcilerine dagitilmis sorumluluk"
LANG_SCOPE = "Turkce, Ispanyolca, Ingilizce"
...
SCOPE_INTRO = (f"Bu calisma, {BRAND} icin kurgulanan ID Exchange platformunun ilk uretim "
               ...
               "hesaplanmistir.")
SCOPE_FLOWS = [
    "BBVA Group, BBVA Espana, BBVA Mexico, BBVA Colombia, BBVA Peru ve Garanti BBVA benzeri istirakler icin ulke/sirket ayrimi.",
    "Fikir paylasimi, fikir borsasi, oylama, yorum, AI analiz ve yonetici paneli akislari.",
    "Dis girisimci basvurulari ve admin tarafindan ilk yonlendirme sureci.",
    "Ulke bazli gorunurluk, dil bazli moderasyon ve holding geneli raporlama yaklasimi.",
]

ADMIN_TASKS = [
    ("Adil kullanim ve piyasa davranisi", "8-12 saat", "Suni fiyat yukseltme, grup ici koordineli alim-satim ve olagan disi hareketlerin kontrolu"),
    ("Sikayet ve icerik uygunlugu", "6-8 saat", "Uygunsuz, yaniltici veya kurum kulturune aykiri iceriklerin incelenmesi"),
    ("Dis basvuru yonlendirme", "4-6 saat", "Girisimci ve dis paydaslarin dogru ulke/is birimine aktarilmasi"),
    ("Hata ve gelistirme bildirimleri", "5-7 saat", "Teknik hatalarin urun/yazilim ekibine net ve izlenebilir sekilde raporlanmasi"),
    ("Haftalik yonetim ozeti", "5-9 saat", "En aktif fikirler, riskli basliklar, ulke kirilimi ve karar bekleyen konularin ozetlenmesi"),
]

COUNTRY_TABLE = [
    ("Ispanya", "12.000", "BBVA, BBVA Technology, BBVA Research", "Ispanyolca/Ingilizce"),
    ("Meksika", "10.000", "BBVA Mexico", "Ispanyolca"),
    ("Turkiye", "9.000", "Garanti BBVA ve bagli istirakler", "Turkce"),
    ("Kolombiya", "5.500", "BBVA Colombia", "Ispanyolca"),
    ("Peru", "4.500", "BBVA Peru", "Ispanyolca"),
    ("Arjantin", "3.500", "BBVA Argentina", "Ispanyolca"),
    ("Uruguay", "2.000", "BBVA Uruguay", "Ispanyolca"),
    ("Diger/merkez ekipler", "3.500", "Holding ve global destek", "Ingilizce"),
]
ADMIN_BREAKDOWN_NOTE = ("10-14 sorumlu ifadesi tam zamanli admin anlamina gelmez. Bu modelde "
                         ...
                         "28-42 saat/hafta araligi yeterli gorulur; yalnizca buyuk kampanya, "
                         "odul donemi veya dis basvuru cagrisi doneminde gecici ek destek "
                         "gerekebilir.")
CONTROL_POINTS = [
    "Bankacilik ve yatirim alanlarinda finansal tavsiye sinirlari ayrica netlestirilmelidir.",
    "Ulke bazli veri saklama ve erisim kurallari canliya gecis oncesinde hukuk/uyum ekipleriyle dogrulanmalidir.",
    "Fikir borsasi puanlari gercek finansal varlik gibi degil, kurum ici motivasyon ve onceliklendirme sinyali gibi konumlandirilmalidir.",
