...
doc = SimpleDocTemplate(
    ...
    author="BBVA Grup NIE Platform Muhendislik Ekibi",
    subject="BBVA Innovation Exchange (NIE) - Technical Architecture Report v2.6.0"
)
...
cover_inner = [
    [Paragraph("BBVA GRUP &middot; NEW IDEA EXCHANGE", S("CE", fontSize=10, fontName="Helvetica-Bold", textColor=HexColor("#94a3b8")))],
    [Spacer(1, 8 * mm)],
    [Paragraph("Teknik Mimari<br/>Raporu", COVER_TITLE)],
    [Spacer(1, 3 * mm)],
    [Paragraph("BBVA Grup ve istiraklerinin (Garanti BBVA, BBVA Portfoy, BBVA Yatirim, BBVA Kart, "
               "BBVA Yesil Finansman ve digerleri) 5 ulke portalinda kullandigi platform altyapisi, "
...
callout(
    "<b>BBVA Innovation Exchange (NIE)</b>, BBVA Grup ve istiraklerinin (Garanti BBVA, BBVA Portfoy, "
    "BBVA Yatirim, BBVA Kart, BBVA Yesil Finansman, BBVA Odeme, BBVA Faktoring, BBVA Teknoloji ve "
...
simple_table(["Modul", "Teknoloji / Yapi", "Detay / Islev"], [
    ...
    ["Baslangic Degerlemesi (v2.5)", "Standart 100 BC Acilis Fiyati", "Borsaya listelenen her yeni proje/fikir, kaynagina (sihirbaz, sikayet kutusu, hizli giris) bakilmaksizin 100 BC sabit acilis degerlemesiyle baslar."],
    ["Karar Kurulu Coin Sistemi (v2.5)", "10.000 BC Karsiliginda Dogrudan Tasima", "Proje sahibi, kendi fikrini/projesini veya onemli bir karar onerisini 10.000 BC odeyerek dogrudan Karar Kurulu inceleme listesine tasiyabilir. Bakiye yetersizse islem engellenir; kesinti yalnizca kullanici onayindan sonra gerceklesir."],
...
footer_row = Table(
    [[Paragraph("<b>BBVA GRUP &middot; NEW IDEA EXCHANGE</b> - Teknik Mimari Raporu v2.6.0", FOOTER_TXT),
