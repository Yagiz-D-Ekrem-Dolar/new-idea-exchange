...
{\large\bfseries BBVA Kurumsal İnovasyon Borsası}\\[6pt]
{\large Teknik Mimari, Mevcut Durum İncelemesi ve Sürdürülebilirlik Raporu}\\[8pt]
\docline\\[6pt]
{\small Tarih: 20 Haziran 2026 \quad Branch: \code{bbva} \quad Kapsam: Kod incelemesi + teknik rapor}
\end{center}
...
Uygulama, backend'i sınırlı olan fakat ürün demosu açısından geniş kapsamlı bir \textbf{vanilla JavaScript single page application} olarak çalışır. Ana kullanıcı deneyimi \code{public/app.js} içinde tutulur; BBVA Grup iştirakleri, kullanıcılar, fikirler, ekipler, duyurular, gündem, yarışmalar ve kulüp verileri \code{public/mockData.js} içinde modellenir. Sunucu tarafında iki görev vardır: statik dosya servis etmek ve fikir analizi için \code{/api/ai/analyze-idea} endpoint'ini çalıştırmak.
...
\begin{enumerate}
  ...
  \item BBVA branch'inde eski markalamaya dair bazı kalıntılar temizlenmiş, tüm iştirakler BBVA standartlarına uyarlanmıştır.
...
\code{public/assets/*} & BBVA/iştirak logoları, ülke bayrakları ve görsel varlıklar.\\
...
NEW IDEA EXCHANGE, kurum içi fikir, proje, araştırma, şikayet, veri, duyuru, ekip ve ürünleşme süreçlerini tek bir etkileşim alanında toplar. Uygulama BBVA Grup ekosistemine göre markalanmıştır; iştirakler, ülkeler, şehirler ve kampüsler mock veriyle temsil edilir.
...
\code{public/mockData.js} içinde \code{affiliationCompanies} listesi BBVA Grup ve iştiraklerini temsil eder. Her şirket; logo, kısa ad, ülke, şehir, kampüs ve departman alanlarıyla modellenir.
...
Terminoloji & BBVA branch'inde eski e-posta domainleri ve eski ürün adları BBVA standartlarıyla güncellenmiştir. & Brand vocabulary taraması ve master text dictionary.\\
...
\begin{enumerate}
  ...
  \item Global aramada \code{Garanti BBVA} ara ve fikir/ekip sonuçlarını gör.
...
Uygulama son durumda GitHub \code{bbva} branch'inde tutulmaktadır. Vercel production deploy için mevcut komut akışı:
...
\midrule
P0 & Brand cleanup & Eski İş NEW/is-new metinleri BBVA Grup demosunun profesyonel algısını zedeler.\\
...
NEW IDEA EXCHANGE mevcut haliyle güçlü bir demo ürünüdür. BBVA Grup markasına uyarlanmış iştirak verisi, çok ülkeli kullanıcı seti, fikir borsası, portföy, stüdyo, ekip, sosyal, yarışma, eğitim, etkinlik, yönetici dashboardu ve AI destekli fikir analizi gibi geniş bir ürün hikayesi sunar.
